...
describe('UserService', () => {
  ...
  describe('create', () => {
    ...
    it('should throw InternalServerErrorException if Prisma throws an unexpected error', async () => {
      ...
      expect(logger.error).toHaveBeenCalledWith(
        expect.stringContaining('POST: error: Error: Unexpected database error')
      );
    });
  });
  ...
  describe('findAll', () => {
    ...
    it('should throw InternalServerErrorException if Prisma throws an unexpected error', async () => {
      ...
      // Ensure the error was logged
      expect(logger.error).toHaveBeenCalledWith(
        expect.stringContaining('GET: error: Error: Unexpected database error')
      );
    });
  });
  ...
  describe('findOne', () => {
    ...
    it("should throw UnauthorizedException if a non-admin user tries to access another user's data", async () => {
      ...
      await expect(userService.findOne(field, value, mockUser)).rejects.toThrow(
        UnauthorizedException
      );
    });
    ...
    it('should throw InternalServerErrorException if Prisma throws an unexpected error', async () => {
      ...
      // Ensure the error was logged
      expect(logger.error).toHaveBeenCalledWith(
        expect.stringContaining('GET/{id}: error: Error: Unexpected database error')
      );
    });
  });
  ...
  describe('update', () => {
    ...
    it("should throw UnauthorizedException if a non-admin user tries to update another user's data", async () => {
      ...
      await expect(userService.update(field, value, dto, mockUser)).rejects.toThrow(
        UnauthorizedException
      );
    });
    ...
    it('should throw InternalServerErrorException if Prisma throws an unexpected error', async () => {
      ...
      // Ensure the error was logged
      expect(logger.error).toHaveBeenCalledWith(
        expect.stringContaining('PATCH: error: Error: Unexpected database error')
      );
    });
  });
  ...
  describe('remove', () => {
    ...
    it('should throw UnauthorizedException if a non-admin user tries to delete another user', async () => {
      ...
      await expect(userService.remove(field, value, mockUser)).rejects.toThrow(
        UnauthorizedException
      );
    });
    ...
    it('should throw InternalServerErrorException if Prisma throws an unexpected error', async () => {
      ...
      // Ensure the error was logged
      expect(logger.error).toHaveBeenCalledWith(
        expect.stringContaining(`DELETE: error: \"Error: Unexpected database error\"`)
      );
    });
  });
});
